...
static const u8 sText_EVO_LEVEL_DECIDUEYE_HISUI[] = _("{LV}{UP_ARROW} to {STR_VAR_2}, Decidueye-H persona");
static const u8 sText_EVO_LEVEL_URSHIFU_SINGLE[] = _("{LV}{UP_ARROW} to {STR_VAR_2}, Urshifu-Singl persona");
