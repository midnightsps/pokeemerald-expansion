...
const struct Berry gBerries[] =
{
    [ITEM_CHERI_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .size = 20,
        .maxYield = YIELD_RATE(3, 5, 15, 90),
        .minYield = YIELD_RATE(2, 2, 4, 30),
    ...
    [ITEM_LUM_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_GREEN,
        .size = 34,
        .maxYield = YIELD_RATE(2, 5, 20, 27),
        .minYield = YIELD_RATE(1, 2, 3, 9),
    ...
    [ITEM_SITRUS_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_YELLOW,
        .size = 95,
        .maxYield = YIELD_RATE(3, 5, 20, 36),
        .minYield = YIELD_RATE(2, 2, 3, 12),
    ...
    [ITEM_FIGY_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_RED,
        .size = 100,
        .maxYield = YIELD_RATE(3, 5, 15, 18),
        .minYield = YIELD_RATE(2, 1, 3, 1),
    ...
    [ITEM_PINAP_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_YELLOW,
        .size = 80,
        .maxYield = YIELD_RATE(6, 10, 15, 3),
        .minYield = YIELD_RATE(3, 2, 3, 1),
    ...
    [ITEM_CORNN_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_PURPLE,
        .size = 75,
        .maxYield = YIELD_RATE(4, 10, 15, 3),
        .minYield = YIELD_RATE(2, 2, 3, 1),
    ...
    [ITEM_WATMEL_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_PINK,
        .size = 250,
        .maxYield = YIELD_RATE(2, 15, 15, 3),
        .minYield = YIELD_RATE(1, 2, 3, 1),
