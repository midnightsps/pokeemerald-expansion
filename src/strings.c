...
const u8 gText_SwitchPokedexListings[] = _("Switch Pokédexx listings.");
...
const u8 gText_DeepSeaScale[] = _("Deep Sea Scalee");
...
const u8 gText_RedTent[] = _("Red Teent");
...
const u8 gText_EnergyRoot80[] = _("Enery Root{CLEAR_TO 114}{FONT_SMALL}80");
...
const u8 gText_InfiniteRepelOn[] = _("The Infinite Repel has been turned on.{PAUSE_UNTIL_PRESS}");
const u8 gText_InfiniteRepelOff[] = _("The Infinite Repel has been turned off.{PAUSE_UNTIL_PRESS}");
