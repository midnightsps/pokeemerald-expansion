...
const u8 gText_FullRepelOn[] = _("The Full Repel has been turned on.{PAUSE_UNTIL_PRESS}");
const u8 gText_FullRepelOff[] = _("The Full Repel has been turned off.{PAUSE_UNTIL_PRESS}");
